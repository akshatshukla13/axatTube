            ...
            <div class="fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-white bg-[#121212] duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none">
              ...
              <div class="mb-8 mt-auto px-4 sm:mb-0 sm:mt-0 sm:px-0">
                <button class="flex w-full gap-4 text-left sm:items-center">
                  <img
                    src={logedin.data.avatar}
                    alt={logedin.data.userName}
                  ...
                  <div class="w-full pt-2 sm:hidden">
                    ...
                    <p class="text-sm text-gray-300">{logedin.data.userName}</p>
                  </div>
                </button>
              </div>
            </div>
